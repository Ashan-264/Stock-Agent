...
GROQ_API_KEY = "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" #os.getenv("GROQ_API_KEY")
client = Groq(
...
def query_pinecone():
    ...
    try:
        ...
        llm_response = client.chat.completions.create(
            model="llama-3.3-70b-versatile",  # Adjust to your available model
            messages=[
...
def news_sentiment():
    ...
    if not isinstance(feed, list):
        return jsonify({
        "error": "Alpha Vantage did not return a feed array",
        "raw_response": data
    }), 500
